...
- **NEVER edit `flake.nix` directly** - It is auto-generated by flake-file. Edit the source modules (typically `modules/flake/dendritic.nix` or similar) and run `nix run .#write-flake` to regenerate it.

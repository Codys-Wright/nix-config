        ...
        nixos =
          ...
          let
            ...
            shouldEnable =
              ...
              else if hostKeys != null then
                true # If hostKeys provided, enable
              else
                hasHostKey; # Auto-detect based on file existence

            # Determine which host keys to use
            actualHostKeys =
              if hostKeys != null then
                hostKeys
              else if hasHostKey then
                [ defaultHostKeyPath ]
              else
                [ ];
            ...
            actualAuthorizedKeys =
              if authorizedKeys != null then
                authorizedKeys
              else if cfg.sshKey != null then
                [ cfg.sshKey ]
              else
                [ ];

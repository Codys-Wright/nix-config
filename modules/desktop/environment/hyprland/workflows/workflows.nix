            ...
            wayland.windowManager.hyprland.workflows.profiles = lib.mkDefault (
              let
                ...
                loadedProfiles = map (
                  ...
                  if builtins.isFunction imported then imported { } else imported
          ...
          # This prevents the workflow switcher script from failing
          {
            ...
            xdg.configFile =
              let
                ...
                animationPresets = builtins.filter (
                  name: lib.hasSuffix ".nix" name && name != "global.nix"
                ) animationFiles;
                    ...
                    value = {
                      text =
                        let
                          ...
                          globalSettings =
                            globalAnimModule.FTS.desktop._.environment._.hyprland._.presets._.animations._.global.settings;
                  ...
                  # Global decorations
                  {
                    ...
                    value = {
                      text =
                        ...
                        in
                        lib.hm.generators.toHyprconf { attrs = globalSettings; };
                    };
                  }
                  # Global layouts
                  {
                ...
                animationConfigs = builtins.listToAttrs (
                  map (
                    ...
                    let
                      ...
                      settings =
                        presetModule.FTS.desktop._.environment._.hyprland._.presets._.animations._.${presetName}.settings;
                ...
                decorationPresets = builtins.filter (
                  name: lib.hasSuffix ".nix" name && name != "global.nix"
                ) decorationFiles;
                ...
                windowRulesPresets = builtins.filter (
                  name: lib.hasSuffix ".nix" name && name != "global.nix"
                ) windowRulesFiles;
                ...
                workspaceRulesPresets = builtins.filter (
                  name: lib.hasSuffix ".nix" name && name != "global.nix"
                ) workspaceRulesFiles;

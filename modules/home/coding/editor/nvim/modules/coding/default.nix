...
with lib.${namespace};
let
  cfg = config.${namespace}.coding.editor.nvim.modules.coding;
in
{
  options.${namespace}.coding.editor.nvim.modules.coding = with types; {
    enable = mkBoolOpt false "Enable nvim coding modules";
  };

  config = mkIf cfg.enable {
    # Configure nvf coding settings

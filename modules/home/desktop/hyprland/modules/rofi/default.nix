...
with lib.${namespace};
let
  cfg = config.${namespace}.desktop.hyprland.modules.rofi;
...
in
{
  options.${namespace}.desktop.hyprland.modules.rofi = with types; {
    enable = mkBoolOpt false "Enable Rofi application launcher";
  };

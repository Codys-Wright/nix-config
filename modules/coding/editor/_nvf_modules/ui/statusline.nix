# Bufferline + lualine configuration (currently fully commented out — NvChad
# statusline/tabufline are used instead; kept for reference)
# Split from ../ui.nix — returns config.vim settings directly (empty for now)
{ lib, ... }:
{

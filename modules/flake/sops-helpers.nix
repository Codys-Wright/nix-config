    ...
    { pkgs, system, ... }:
    {
      ...
      apps = {
        ...
        sops-gen-key = {
          type = "app";
          program = toString (
            pkgs.writeShellScriptBin "sops-gen-key" ''
              set -e
        ...
        sops-get-host-key = {
          type = "app";
          program = toString (
            pkgs.writeShellScriptBin "sops-get-host-key" ''
              set -e
        ...
        sops-gen-secret = {
          type = "app";
          program = toString (
            pkgs.writeShellScriptBin "sops-gen-secret" ''
              set -e
              LENGTH="''${1:-64}"
        ...
        sops-init-config = {
          type = "app";
          program = toString (
            pkgs.writeShellScriptBin "sops-init-config" ''
              set -e
        ...
        sops-init-secrets = {
          type = "app";
          program = toString (
            pkgs.writeShellScriptBin "sops-init-secrets" ''
              set -e
